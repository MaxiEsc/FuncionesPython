#En este caso presentamos ejercicios con una maquinas de snaks en este
#En este reto Tenemos que crear una especie de maquina de gestione Snasks
...
def comprar_snack():
    id_snack = int(input('Qué snack quieres comprar (Ingrese id) ?: '))
