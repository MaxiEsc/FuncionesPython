#Con todo lo aprendido se realizara un sistema de inventario de Producto utilizando las funciones en cuestion
...
def mostrar_inventario():
    ...
    for producto in inventario:
        ...
        print(f'Precio: ${producto.get("precio")}, Cantidad: {producto.get("cantidad")}')
...
def buscar_producto_por_id():
    ...
    id_buscar = int(input('Ingresa el id para buscar un producto: '))
    for producto in inventario:
