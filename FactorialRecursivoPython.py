#Ejercicio del clasico factorial de un numero en matematica
# Siempre debemos priorizar el caso base en este caso es el que devuelve la multiplicacion del primer numero 1
